...
#if !defined(PDM_DEV_HEADER)
#define PDM_DEV_HEADER
/*
***************************************************************************************************
*                                             DEFINITIONS
***************************************************************************************************
...
****************************************************************************/
#define PDM_BASE                        (0x1B400000UL)
#define PDM0_BASE                       (0x1B400000UL)
#define PDM1_BASE                       (0x1B410000UL)
#define PDM2_BASE                       (0x1B420000UL)
 ...
 * Define -  SHIFT Value for PDMn_EN_VUP_TRIG_A/B/C/D Channel
             (X is CH-A : 0, CH-B: 1, CH-C: 2, CH-D: 3)
****************************************************************************/
#define PDM_GetOPENEnalbeReg(X)         ((0UL) + ((X) * (0x1UL)))
...
#define PDM_GetOPModeOuputIdleReg(X)        ((20UL) + ((X) * (0x1UL)))
...
/****************************************************************************
 * Define - PDM PORT CONFIG Register Map BASE Addr.
****************************************************************************/
#define PDM_PCFG_BASE                   (0x1B430000UL)

/****************************************************************************
 * Define -  OFFSET of the PDM_0/1/2_OUT_CTRL from PDM_PCFG_BASE
            (X is PDM0 : 0, PDM1: 1, PDM2 : 2)
****************************************************************************/
#define PDM_GetPortCfgOutCtrlReg(X)     ((0UL) + ((X) * (0x04UL)))

/****************************************************************************
 * Define -  SHIFT Value for PDMn_A/B/C/D Channel_OUT_CTRL
             (X is CH-A : 0, CH-B: 1, CH-C: 2, CH-D: 3)
****************************************************************************/
#define PDM_GetPortCfgOutCtrlShift(X)   ((0UL) + ((X) * (0x8UL)))

/****************************************************************************
 * Define -  OFFSET of the PDM_PCFG_0/1/2_PORT_CFG from PDM_PCFG_BASE
            (X is PDM0 : 0, PDM1: 1, PDM2 : 2)
****************************************************************************/
#define PDM_GetPortCfgSelectionReg(X)   ((0x10UL) + ((X) * (0x04UL)))

/****************************************************************************
 * Define -  SHIFT Value for PDMn_A/B/C/D Channel_PORT CFG from PDM_PCFG_BASE
             (X is CH-A : 0, CH-B: 1, CH-C: 2, CH-D: 3)
****************************************************************************/
#define PDM_GetPortCfgSelectionShift(X) ((0UL) + ((X) * (0x8UL)))

/****************************************************************************
 * Define -  OFFSET of PDM_PCFG_WR_PW Register from PDM_PCFG_BASE
****************************************************************************/
#define PDM_PCFG_WR_PW_REG_OFFSET       (0x1CUL)

/****************************************************************************
 * Define -  OFFSET of PDM_PCFG_WR_LOCK Register from PDM_PCFG_BASE
****************************************************************************/
#define PDM_PCFG_WR_LOCK_REG_OFFSET     (0x20UL)

/****************************************************************************
 * Define -  WRITE LOCK PASSWORD
****************************************************************************/
#define WRITE_LOCK_PASSWORD             (0x8030ACE5UL)
 ...
 * Define - PMM Register Map BASE Addr.for
 Safey Feature
****************************************************************************/
#define PMM_BASE                        (0x1B440000UL)
#define PMM0_BASE                       (0x1B440000UL)
#define PMM1_BASE                       (0x1B450000UL)
#define PMM2_BASE                       (0x1B460000UL)
