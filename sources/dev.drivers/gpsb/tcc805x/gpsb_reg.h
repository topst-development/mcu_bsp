...
#define CH_SDM                          (uint32)(3UL)
#define CH_RVC                          (uint32)(4UL)
...
#define GPSB_PCFG_BASE                  ((uint32)MCU_BSP_GPSB_BASE + (uint32)0x60000UL)
#define GPSB_IO_MONITOR_BASE            ((uint32)MCU_BSP_GPSB_BASE + (uint32)0x70000UL)
...
#define GPSB_PORT_SEL0                  (uint32)(0x00UL)
#define GPSB_PORT_SEL1                  (uint32)(0x04UL)
#define GPSB_SDM_RVC_CTRL_SEL           (uint32)(0x08UL)
#define GPSB_LB_CFG                     (uint32)(0x0CUL)
#define GPSB_PCFG_WR_PW                 (uint32)(0x10UL)
#define GPSB_PCFG_WR_LOCK               (uint32)(0x14UL)
...
#define GPSB_SDM_CH                     (uint32)(3UL)
#define GPSB_PORT_NUM                   (uint32)(44UL)

#define GPSB_INTERFACE_SDM              (uint32)(0x00UL)
#define GPSB_INTERFACE_RVC              (uint32)(0x01UL)

/* SDM & RVC Channel mask */
#define SDM_CHANNEL_MASK                (uint32)(0x7UL)
#define RVC_CHANNEL_MASK                (uint32)(0x7UL)
#define RVC_CHANNEL_SHIFT               (uint32)(8UL)
...
extern const uint32             gpsbport[GPSB_PORT_NUM][4];
